<p align="center">
  <img src="public/logo.png" alt="CodeX logo" width="90" />
</p>

<h1 align="center">CodeX</h1>

<p align="center">
  A real-time collaborative code editor with team workspaces, live chat, WebRTC calls, and AI-powered code review.
</p>

---

**Live demo:** [https://codexx-alpha.vercel.app/](https://codexx-alpha.vercel.app/)
...
**Frontend:** React 19, Redux Toolkit, Tailwind CSS 4, Monaco Editor, Vite
**Backend:** Node.js, Express, MongoDB (Mongoose), Socket.IO
**AI:** Groq (LLaMA 3.3 70B) for automated code review
**Real-time voice/video:** WebRTC with configurable STUN/TURN servers
...
- A [Groq API key](https://console.groq.com) for AI code review
